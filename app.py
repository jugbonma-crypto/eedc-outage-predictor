...
THRESHOLD_PATH = BASE_DIR / "models" / "prediction_threshold.pkl"
DATA_PATH = BASE_DIR / "data" / "outage_data.csv"
EVALUATION_PATH = BASE_DIR / "outputs" / "model_evaluation.json"
...
def get_backend_inputs(state, area, hour):
    ...
    return {
        ...
        "estimated_load_mw": float(row["estimated_load_mw"]),
